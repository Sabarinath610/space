...
class _LoginPageState extends State<LoginPage> {
  final _emailC = TextEditingController(); final _passC = TextEditingController();
          ...
          child: Column(children: [
            ...
            BlocConsumer<AuthBloc, AuthState>(
              ...
              builder: (context, state) {
                ...
                return ElevatedButton(onPressed: () => context.read<AuthBloc>().add(LoginRequested(email: _emailC.text.trim(), password: _passC.text.trim())), child: const Text('Login'));
              },
            ),
          ]),
        ),
