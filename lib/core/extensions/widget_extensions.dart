...
extension PaddingHelper on Widget {
  ...
  Widget padSym({double v = 0, double h = 0}) =>
      Padding(padding: EdgeInsets.symmetric(vertical: v, horizontal: h), child: this);
...
extension MarginHelper on Widget {
  ...
  Widget marginSym({double v = 0, double h = 0}) =>
      Container(margin: EdgeInsets.symmetric(vertical: v, horizontal: h), child: this);
